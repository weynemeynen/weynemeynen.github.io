...
export default function FilterPanel({ term, handlerSearchTerm }) {
  ...
  return (
    <form className={`filter-panel d-flex py-3 border-bottom ${borderColor}`} onSubmit={(e) => e.preventDefault()}>
