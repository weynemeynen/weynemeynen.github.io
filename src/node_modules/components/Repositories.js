  ...
  return (
    <div className='repositories'>
      {repos.map((repo, index) => {
        ...
        return (
          <div className={`card border-top-0 border-start-0 border-end-0 border-bottom rounded-0 bg-transparent`} key={repo.id}>
            <div className="row g-0">
              <div className="col-sm-12">
                <div className="card-body">
                  <a href={repo.homepage} target='_blank' className={`card-title fs-6 fw-bold text-decoration-none text-${textColorLink}`}>{repo.name}</a>
